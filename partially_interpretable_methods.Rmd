...
rf_optimal_regression_predict <- predict.train(rf.caret_regression, newdata = test_regression)
#rf.caret$bestTune
stopImplicitCluster()

save(rf_optimal_regression, file="best_model_random_forest_regression.RData")
save(rf_optimal_regression_predict, file="best_model_random_forest_regression_predict.RData")
```

## Load the cross validation random forests

```{r}
load("D:/Memoire/application/best_model_random_forest_classification.RData")
load("D:/Memoire/application/best_model_random_forest_regression_predict.RData")
